...
public class MyListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			vi = inflater.inflate(R.layout.przepis, null);

		TextView przepisID = (TextView) vi.findViewById(R.id.przepisID);
		TextView autorID = (TextView) vi.findViewById(R.id.autorID);
		TextView Tytul = (TextView) vi.findViewById(R.id.Tytul);
		TextView kategoria = (TextView) vi.findViewById(R.id.kategoria);
		ImageView image_view = (ImageView) vi.findViewById(R.id.zdjecieWszystkiePrzepisy);
		RatingBar rating = (RatingBar) vi.findViewById(R.id.ratingBar1);
