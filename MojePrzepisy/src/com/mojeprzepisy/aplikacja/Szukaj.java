...
public class Szukaj extends ListActivity {
	...
	private ArrayList<HashMap<String, String>> znalezionePrzepisy;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		szukajButton.setTypeface(MyBold);
	...
	class WyszukajPrzepis extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			znalezionePrzepisy = new ArrayList<HashMap<String, String>>();
		}
